                ...
                <div class="colm colm12">
                	<div style="width:620px;border:2px solid #000;background:#eee;padding:5px;margin: 0 auto; margin-bottom:15px; text-align: center">
                		...
                		?>
                			...
                			<? if (!empty($auto_make2)) { ?><div class="numbutton1">2</div><div class="makemodel"><?php echo $auto_year2 ?> - <?php echo $auto_make2 ?> - <?php echo $auto_model2 ?> - $<?php echo $auto_price2 ?></div><div style="clear:both"></div><?php } ?>
                			<? if (!empty($auto_make3)) { ?><div class="numbutton1">3</div><div class="makemodel"><?php echo $auto_year3 ?> - <?php echo $auto_make3 ?> - <?php echo $auto_model3 ?> - $<?php echo $auto_price3 ?></div><div style="clear:both"></div><?php } ?>
                			<? if (!empty($auto_make4)) { ?><div class="numbutton1">4</div><div class="makemodel"><?php echo $auto_year4 ?> - <?php echo $auto_make4 ?> - <?php echo $auto_model4 ?> - $<?php echo $auto_price4 ?></div><div style="clear:both"></div><?php } ?>
                			<? if (!empty($auto_make5)) { ?><div class="numbutton1">5</div><div class="makemodel"><?php echo $auto_year5 ?> - <?php echo $auto_make5 ?> - <?php echo $auto_model5 ?> - $<?php echo $auto_price5 ?></div><div style="clear:both"></div><?php } ?>
                			<br>
...
<!--                         <input type="text" name="strPickup_Address2" id="strPickup_Address2" size="40" style="margin-top:5px;"> -->
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        City: <br><div style="font-weight: normal;"><?php echo $strQuote_shippingfromcity  ?></div>
                        <input type="hidden" name="strPickup_City" id="strPickup_City" value="<?php echo $strQuote_shippingfromcity  ?>" >

                    </div>

                    <div class="colm colm3">
                        State:<br><div style="font-weight: normal;"><?php echo $strQuote_shippingfromstate  ?></div>
                    ...
                    <div class="colm colm4">         
                        Zip:<br>
                        <?php if(session('admin')=="") { ?>
                        <div style="font-weight: normal;"><?php echo $strQuote_shippingfromzip  ?></div>
...
<!--                         <input type="text" name="strDeliver_Address2" id="strDeliver_Address2" size="40" style="margin-top:5px;"> -->
                ...
                <div class="frm-row">
                    <div class="colm colm5">     
                        City: <br><div style="font-weight: normal;"><?php echo $strQuote_shippingtocity  ?></div>
                        <input type="hidden" name="strDeliver_City" id="strDeliver_City" value="<?php echo $strQuote_shippingtocity  ?>">
                    </div>

                    <div class="colm colm3">             
                        State: <div style="font-weight: normal;"><?php echo $strQuote_shippingtostate  ?></div>
                    ...
                    <div class="colm colm4">         
                        Zip:<br>
                        <?php if(session('admin')=="") { ?>
                        <div style="font-weight: normal;"><?php echo $strQuote_shippingtozip  ?></div>
