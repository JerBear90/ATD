...
<div class="smart-forms">
    ...
    <form action="?step=7" method="post" name="mainform" id="mainform">
		...
		function calctip() {
		    ...
		    $('.balanceduedisp').html(newbalance + ' USD');
		}
		</script> 
        ...
        <div class="frm-row">
            ...
            <div class="colm colm5">
                ...
                <div class="frm-row">
                    <div class="colm colm12" style="margin-top: 30px">
                    </div>
                </div>
                <div class="frm-row">
                    <div class="colm colm12">
                ...
                <div class="frm-row">
                    ...
                    <div class="colm colm12" style="margin-top: 10px;">
			            ...
			            <label class="option" style="display:none;">
			        	    <input type="radio" name="CarrierTip" id="CarrierTip0" value="0" onclick="calctip();" checked="checked"><span class="radio"></span> 0 USD
			        	</label>
			        	
			        	<label class="option" style="display:inline;">
			        	    <input type="radio" name="CarrierTip" id="CarrierTip25" value="25" onclick="calctip();"><span class="radio"></span> 25 USD
			        	</label>
			        	
			        	<label class="option" style="display:inline;">
			        	    <input type="radio" name="CarrierTip" id="CarrierTip50" value="50" onclick="calctip();"><span class="radio"></span> 50 USD
			        	</label>
			        	
			        	 <label class="option" style="display:inline;">
			        	    <input type="radio" name="CarrierTip" id="CarrierTip75" value="75" onclick="calctip();"><span class="radio"></span> 75 USD
			        	</label>
		            </div>
        ...
        <div class="frm-row">
            <div class="colm colm12">
                <div style="margin:25px 0 25px 0;width:100%;border-top:#999999 solid thin;"></div>
            </div>
        </div>
        ...
        <div class="frm-row">
            <div class="colm colm12">
                ...
                <div class="frm-row">
                    ...
                    <div class="colm colm4">
                        <span class="balanceduedisp"><?php echo $strBalance  ?> USD</span>
                    </div>
                </div>
                <div class="frm-row">
                    <div class="colm colm3">
		...
		<div class="frm-row">
            <div class="colm colm4">
                <button type="submit" class="goonbutton">
                    Complete Order&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-right"></i>
                </button>
            </div>
        </div>
    </form>
