...
if (session('intquote') == 1) {
    if (session('rep') == "claydough" || session('rep') == "mrupers"
        ) {
       $debug=1; 
    }
}
        ...
        <?php } else { ?>
                    ...
                    <div class="colm colm3">
                        <div class="stateleft">
                            ...
                            ?>
                            	...
                            	<br><br>
                            	<a href="#" onclick="reverselocation();"><div style="padding:5px;background:#00B306;color:white;border: 2px solid black;font-weight:bold;font-size:12px;width: 180px; margin: 0 auto;">Reverse Location</div></a>
                            	...
                            	<a href="/internal-quote/?quoteaction=new" style="padding:5px 30px;background:blue;color:white;border: 2px solid black;font-weight:bold;font-size:12px;">New Internal Quote</a>
                            	<br><br>
                            	<a href="#" onclick="reverselocation();"><div style="padding:5px;background:#00B306;color:white;border: 2px solid black;font-weight:bold;font-size:12px;width: 180px; margin: 0 auto;">Reverse Location</div></a>

                            	<br>
                            	<a href="/internal-quote/?quoteaction=redo" style="padding:5px 30px;background:#ffcf17;color:black;border: 2px solid black;font-weight:bold;font-size:12px;">Redo Internal Quote</a>
                                <? } ?>                            	
                            	</div>
                            <?php
                            }
            ...
            jQuery(document).ready(function() {
                ...
                <div class="section fieldentry">
                    ...
                    <div class="frm-row setupship" style="padding-bottom:20px;">
                        ...
                        <div class="colm colm3 setupshipcol">
                            <div class="pricerow">Standard Price<br/><strong style="color: #308dff;">$<span id="displaybalancestandard" style="color: #308dff;"><?php echo $totalprice ?> Total</span></strong></div>
                            <p>Typically Assigned in 1-7 Days*<br>Probability of that is 85%</p>
                            <button id="confirmLink1" class="submitbutton3">Select Standard<br>set&#8209;up shipment</button>
                            <div class="priceexplain">
                            Credit Card Deposit $<?php echo $strDepositSHOW ?><br>
                            
                            
                            Balance To Driver At Destination $<span id="balancestandard"><?php echo $balancestandard ?></span>
                            </div>

			                <div class="videocta" style="margin-top: 10px;"><a class="wpex-lightbox" href="https://www.youtube.com/embed/PNoqGfVts6I?rel=0&amp;autoplay=1" data-type="iframe" data-options="width:1920,height:1080" onclick="_gaq.push(['_trackEvent', 'YouTube', 'How Standard Pricing Works - Step 3', '']);"><img class="size-full wp-image-22466 aligncenter" src="https://www.autotransportdirect.com/wp-content/uploads/2013/12/videothumb-2-standard-sm.jpg?nocache=1213" alt="videothumb-2-standard-sm" width="450" height="253" /></a></div>
                        </div>
                        <div class="colm colm1"></div>
                        <div class="colm colm3 setupshipcol">
                            <div class="pricerow">Expedited Price <span style="font-size:13px;">(+<?php echo $expeditedrate?>)</span><br/><strong style="color: #308dff;">$<span id="displayexpeditedprice" style="color: #308dff;"><?php echo $expeditedprice ?>  Total</span></strong></div>
                            <p>Typically Assigned in 1-4 Days*<br>Probability of that is 90%</p>
	        	            ...
	        	            <div class="videocta" style="margin-top: 10px;"><a class="wpex-lightbox" href="https://www.youtube.com/embed/ESShBsMqnB8?rel=0&amp;autoplay=1" data-type="iframe" data-options="width:1920,height:1080" onclick="_gaq.push(['_trackEvent', 'YouTube', 'Why Expedited Pricing Works - Step 3', '']);"><img class="size-full wp-image-22468 aligncenter" src="https://www.autotransportdirect.com/wp-content/uploads/2013/12/videothumb-3-expedited-sm.jpg?nocache=1213" alt="videothumb-3-expedited-sm" width="450" height="253" /></a></div>
                        </div>
                        <div class="colm colm1"></div>
                        <div class="colm colm3 setupshipcol">
                            <div class="pricerow">Rush Price  <span style="font-size:13px;">(+<?php echo $rushrate?>)</span><br/><strong style="color: #308dff;">$<span id="displayrushprice" style="color: #308dff;"><?php echo $rushprice ?>  Total</span></strong></div>
                            <p>Typically Assigned in 1-2 Days*<br>Probability of that is 95%</p>
	        	            ...
	        	            <div class="videocta" style="margin-top: 10px;"><a class="wpex-lightbox" href="https://www.youtube.com/embed/08y-TvcjdsM?rel=0&amp;autoplay=1" data-type="iframe" data-options="width:1920,height:1080" onclick="_gaq.push(['_trackEvent', 'YouTube', 'When To Use Rush Pricing - Step 3', '']);"><img class="size-full wp-image-22470 aligncenter" src="https://www.autotransportdirect.com/wp-content/uploads/2013/12/videothumb-4-rush-sm.jpg?nocache=1213" alt="videothumb-4-rush-sm" width="450" height="253" /></a></div>
				...
				<div class="section fieldentry" style="margin-bottom: 12px;padding-bottom: 20px;">
                    <div class="frm-row" style="border-bottom: 1px solid #CCC; padding-top: 10px;">
                        <div class="colm colm12">
                            <div style="text-align: center;">

                            
                                <div style="font-weight:bold;font-size:1.7em;margin-bottom: 10px;">
                                   Door-to-Door Service.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Insurance is included.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No taxes or hidden fees.
                                </div>
                                ...
                                <p>Rated <img src="//d36b03yirdy1u9.cloudfront.net/images/stars-orange.jpg" style="vertical-align:baseline;display:inline-block;position:relative;"/> by Google + Reviews<br>
                                Rated <span style="color:#D96A20">A+</span> by the Better Business Bureau</p>
                                
                                <div class="savequotecta">
                                <?php
                                $qs = "";    
                                ?>
                                <p><div style="margin: 0 auto;width: 220px;padding: 10px;color: #FFF;background-color: #095BC2;font-size: 16px;font-weight: bold;text-decoration: none;-moz-border-radius: 3px;border-radius: 3px;text-align: center; cursor: pointer" onclick="jQuery('.savequotecta').hide();jQuery('.savequote').slideDown('slow');">Save My Quote</div>
                                </p>
                                </div>
                                ...
                                <div class="savequote" style="display:none;">
                                    <div class="frm-row">
                                        ...
                                        <div class="colm colm6" style="border: 3px solid #ccc; -moz-border-radius: 5px;border-radius: 5px; padding: 20px;">
                                            <form action="" name="savemyquote" id="savemyquote">
                                                ...
                                                <div class="frm-row">
                                                    ...
                                                    <div class="colm colm4">
                                                        <button type="submit" class="goonbutton" style="padding: 11px;">
                                                            Send My Quote!
                                                        </button>
                                                    </div>
                                                </div>
                ...
                <div class="section fieldentry">
                    <div class="frm-row">
                        <div class="colm colm12" style="text-align: center;  font-size: 1.1em;">
                            ...
                            <p><div style="font-weight:bold; text-align: center; font-size: .8em;">
