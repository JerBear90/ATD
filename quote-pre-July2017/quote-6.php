    ...
    <div class="section fieldentry">
        ...
        <div class="frm-row">
            ...
            <div class="colm colm5">
                ...
                <div class="frm-row">
                    <div class="colm colm12"> 
                        Would you like to add more to the amount due the carrier? It sometimes helps.<br>
...
-->
                ...
                <div class="videocta" style="margin: 0;">
                    <a class="wpex-lightbox" href="https://www.youtube.com/embed/C8eRoK49-TU?rel=0&amp;autoplay=1" data-type="iframe" data-options="width:1920,height:1080" onclick="_gaq.push(['_trackEvent', 'YouTube', 'Placing An Auto Shipping Deposit - Step 6', '']);" ><img class="alignnone size-full wp-image-22464" src="/images/youtube/videothumb-12-deposit.jpg" width="255" /></a>
                </div>
        ...
        <div class="frm-row">
            ...
            <div class="colm colm7">
                ...
                <div class="frm-row">
                    ...
                    <div class="colm colm7">
                        $<span class="balanceduedisp"><?php echo $getorder['Balance'] ?></span>
                    </div>
                </div>
                <div class="frm-row">
                    <div class="colm colm5">
