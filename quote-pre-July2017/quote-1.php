...
if ($randnum == 1) {
    ...
    jQuery(document).ready(function() {
        jQuery('.homeform').css('background','url("//d36b03yirdy1u9.cloudfront.net/images/slide-man.jpg?v=2") no-repeat top right');
    });
    </script> 
    <?php
}
            ...
            <input type="hidden" name="auto_model_index">
                ...
                <div class="section">
                	...
                	<div class="frm-row vehicles" style="margin-top:10px;">
                    	...
                    	<div class="colm colm3" style="margin-left: 32px;">
