...
<div style="margin:5px 0 5px 0;width:100%;border-top:#999999 solid thin;"></div>
	...
	<% else %>
		...
		<tr id="liftkit_howmuch" style="display:none;">
			...
			<td>
			<select name="strVehicle_LiftKit_Quantity" id="strVehicle_LiftKit_Quantity">
			<option value="">-- PLEASE SELECT --</option>
		...
		<tr id="lowered_howmuch" style="display:none;">
			...
			<td>
			<select name="strVehicle_Lowered_Quantity" id="strVehicle_Lowered_Quantity">
			<option value="">-- PLEASE SELECT --</option>
			<option value="1">1 inch</option>
			<option value="2">2 inches</option>
			<option value="3">3 inches</option>
		...
		<tr id="oversizedtires_howmuch" style="display:none;">
			...
			<td>
			<select name="strVehicle_Oversized_Tires_Quantity" id="strVehicle_Oversized_Tires_Quantity">
			<option value="">-- PLEASE SELECT --</option>
