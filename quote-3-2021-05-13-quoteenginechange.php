...
if ($howmany == "onevehicle") {
	$totalprice = GetQuote2($auto_year,$auto_make,$auto_model,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,$debug);
	...
	$shipprice1 = GetQuote2($auto_year,$auto_make,$auto_model,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,0);
	...
	if (!empty($auto_make2) && !empty($auto_model2)) {
		$shipprice2 = GetQuote2($auto_year2,$auto_make2,$auto_model2,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,0);
	...
	if (!empty($auto_make3) && !empty($auto_model3)) {
		$shipprice3 = GetQuote2($auto_year3,$auto_make3,$auto_model3,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,0);
	...
	if (!empty($auto_make4) && !empty($auto_model4)) {
		$shipprice4 = GetQuote2($auto_year4,$auto_make4,$auto_model4,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,0);
	...
	if (!empty($auto_make5) && !empty($auto_model5)) {
		$shipprice5 = GetQuote2($auto_year5,$auto_make5,$auto_model5,$shippingfromzip,$shippingtozip,$enclosed,$auto_priceadjustment,0);
...
// DISABLED MULTIVEHICLE DISCOUNTS ON 9/30/2020
/*
		            ...
		            <div class="colm colm12 ">
		                ...
		                <div class="section fieldentry">
	                        ...
	                        <div class="colm colm4 levelofservice" >
	                            ...
	                            <div align="center"><button id="confirmLink1" class="submitbutton3" style="width:90%;">Set&#8209;up Standard<br/>Shipment</button></div>
	                        ...
	                        <div class="colm colm4 levelofservice" style="background: #458bd7;color:#fff">
	                            ...
	                            <div align="center"><button  id="confirmLink2" class="submitbutton3" style="width:90%;">Set&#8209;up Expedited<br/>Shipment</button></div>
	                            <p style="margin-top: 10px;">
									Once your order is assigned a carrier, a nominal partial payment will be charged to the credit card, and the majority carrier balance will be due in Cash or Money Order upon delivery
	                            </p>
	                        </div>
	                        ...
	                        <div class="colm colm4 levelofservice" style="background: #3a5a90;color:#fff">
	                            ...
	                            <div align="center"><button id="confirmLink3" class="submitbutton3" style="width:90%;">Set&#8209;up Rush<br/>Shipment</button></div>
	                            <p style="margin-top: 10px;">
									Once your order is assigned a carrier, a nominal partial payment will be charged to the credit card, and the majority carrier balance will be due in Cash or Money Order upon delivery
            ...
            <div class="section fieldentry">
                ...
                <div class="frm-row" style="margin-bottom: 30px !important;">
                    <div class="colm colm12" style="text-align: center;padding: 20px 0 40px;">
						...
						<div class="trustpilot-widget" data-locale="en-US" data-template-id="53aa8912dec7e10d38f59f36" data-businessunit-id="5195d470000064000530e14c" data-style-height="140px" data-style-width="100%" data-theme="light" data-stars="5" data-schema-type="Organization">
