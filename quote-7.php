...
if ($cys_success == 1) {
  ...
  $sql = "update orders set status = 'NEW', amount_due_driver='$balance', SalesRep_Complete = '$strSalesRep', order_date = NOW(),Billing_Name = '$strBilling_Name', Billing_Address1 = '$strBilling_Address1', Billing_Address2 = '$strBilling_Address2', Billing_City = '$strBilling_City', Billing_State = '$strBilling_State', Billing_Zip = '$strBilling_Zip', Billing_Phone = '$strBilling_Phone', cc_profileid='$customerProfileId', cc_paymentprofileid='$customerPaymentProfileId', cc_lastfour = '$cc_lastfour', cc_capturestatus = 'authorized' where orderid = $strOrderID";
...
{
    .entry-content.entry.clr .banner {
    ...
    .smart-forms.orderreceipt .frm-row .colm6 {
    width: 100% ;
    }
}
...
<h1 class="head">Your Order is Booked!</h1>
<p class="textpara">Your Order ID: <strong>#<?php echo $strOrderID; ?></strong></p>
<p class="textpara">Total Price: <strong>$<?php echo number_format($getorder["Total"],0); ?></strong></p>
<p class="textpara">You have received an email order confirmation.</p>
<p class="textpara">Upon carrier assignment, you will receive an email confirmation.</p>
<p class="textpara">Please print out this page as order receipt, Call 1-800-600-3750 with any questions.</p>
<p class="textpara">Thank you for your business!</p>

</div>
<div class="right-banner">
<img alt="billing info" data-src="/images/staff/order-checkout.jpg" class=" lazyloaded" src="/images/staff/order-checkout.jpg"><noscript><img  alt="billing info" data-src="/images/staff/order-checkout.jpg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" /><noscript><img src="/images/staff/order-checkout.jpg" alt="billing info" /></noscript>
</div>
</div>
</div>
</div>
...
-->
			...
			<div class="colm colm6">
			<div style="color:#0081CC; font-weight: 600; font-size: 1.2em;margin-top:30px">
...
<div class="left-banner">
<p class="spn">The Car Shipping Experts</p>
<h1 class="head">Error: <?php echo $ResponseReason; ?></h1>
<p class="textpara">There was a problem processing your credit card.  If you would like to resubmit<br/>your billing information <a href="javascript:history.back();"><strong>click here to go back.</strong></a></p>
<p class="textpara">If you would like to speak to a representative about this error, please<br/>call 1-800-600-3750 and refer to order number <?php echo $strOrderID; ?>.</p>
<p class="textpara">Thank you for your business!</p>
</div>
<div class="right-banner">
<img alt="billing info" data-src="/images/staff/order-checkout.jpg" class=" lazyloaded" src="/images/staff/order-checkout.jpg"><noscript><img  alt="billing info" data-src="/images/staff/order-checkout.jpg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" /><noscript><img  alt="billing info" data-src="/images/staff/order-checkout.jpg" class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" /><noscript><img src="/images/staff/order-checkout.jpg" alt="billing info" /></noscript>
</div>
</div>
</div>
</div>
