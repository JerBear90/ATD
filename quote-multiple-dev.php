...
<div class="quotemultiple">
    ...
    .quoteformhead {
	    font-size: 1.5em; font-weight:600; color: #fff; padding-top:10px; line-height:23px; margin:0
    }
    ...
    <div class="quoteform">
        ...
        <div class="smart-forms">
            ...
            <form action="/quote-dev/?step=2" method="post" name="autotransportquoteform" id="autotransportquoteform">
	        ...
	        if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
            	...
            	<div class="section">
                    <div class="frm-row">
                        <div class="colm colm12">
                            <div class="option-group field">
                                <div class="quoteformlabel" style="display:inline; top: 0px;">5.</div>
                    			<label class="option" style="display:inline;top:-3px;margin-left:10px;">
            	...
            	<div class="frm-row">
                    <div class="colm colm12">
            		    <input type="button" onclick="submitquote();" value="Get My Car Shipping Quote Now" class="submitquotev2"/>
