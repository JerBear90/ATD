    ...
    <form action="?step=7" method="post" name="mainform" id="mainform">
        ...
        <div class="frm-row">
                <div class="colm colm12" style="margin-top: 10px;">
                    ...
                    <label class="option">
                        <br/>
                        <strong>Carriers Prefer This Method</strong><br/>
                        <input type="radio" name="pricetype" id="pricetype_reg" value="regular" checked="checked"><span class="radio"></span> A Partial Credit Card Payment After Your Vehicle Assignment <span style="font-weight:bold;color:#4472C4;">($0 due now)</span><br/><span style="display:inline-block;margin-left:26px;">Balance Paid To The Carrier With Money Order or Cash Upon Delivery</span>
                    </label><br/>
                    
                    <label class="option">
                        <br/>
                        <strong>Or This Is Okay Too</strong><br/>
                        <input type="radio" name="pricetype" id="pricetype_full" value="full"><span class="radio"></span> A Full Credit Card Payment After Your Vehicle Assignment <span style="font-weight:bold;color:#4472C4;">($0 due now)</span><br/><span style="display:inline-block;margin-left:26px;">No Money Paid To The Carrier Upon Delivery</span>
                        
                    </label><br/><br/>
                    
                    Total Door-to-Door <?php echo $pricetiername ?> Price: $<?php echo $strTotalPrice ?>
                    <br/><br/>
                    </div>
                </div>
            </div>
