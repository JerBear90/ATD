					...
					if(isset($_GET['quoteerror'])) {
						...
						$errormsg = $_GET['quoteerror'] ?>
							<div class="errormsg" align="center">
								...
								<?php } elseif($errormsg == "yearmakemodel") { ?>
									Sorry, you must specify a year, make and model.
								<?php } ?>
	...
	$(document).ready(function() {
		$("#shippingfromzipentry,#shippingtozipentry").keydown(function (e) {
			...
			if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
				...
				<div class="frm-row">
					<div class="colm colm12">
						<input type="button" onclick="submitquote();" value="Get My Auto Shipping Quote Now" class="submitquotev2"/>
