...
<div class="colm colm5">
	...
	Year:<br/>
	<input style="box-shadow: none;background: white;border: 0;" type="text" name="strVehicle_Year<?php echo $vehiclenum ?>" id="strVehicle_Year<?php echo $vehiclenum ?>" value="<?php echo $auto_yeartemp  ?>" size="20" <?php if($_COOKIE['admin']==""=="") { ?>readonly="readonly" style="border:0;"<?php } ?>><?php if($_COOKIE['admin']==""!="") { ?><span class="req">&nbsp;*</span><?php } ?>
	<br/><br/>
	
	Vehicle Make:<br/>
	<input type="text" id="strVehicle_Make<?php echo $vehiclenum ?>" name="strVehicle_Make<?php echo $vehiclenum ?>" value="<?php echo $auto_maketemp  ?>" size="20"  <?php if($_COOKIE['admin']==""=="") { ?>readonly="readonly" style="border:0;"<?php } ?>><?php if($_COOKIE['admin']==""!="") { ?><span class="req">&nbsp;*</span><?php } ?>
	<br/><br/>    
	
	Vehicle Model:<br/>
	<input type="text" id="strVehicle_Model<?php echo $vehiclenum ?>" name="strVehicle_Model<?php echo $vehiclenum ?>" value="<?php echo $auto_modeltemp  ?>"  <?php if($_COOKIE['admin']==""=="") { ?>readonly="readonly" style="border:0;"<?php } ?>><?php if($_COOKIE['admin']==""!="") { ?><span class="req">&nbsp;*</span><?php } ?>
	<br/><br/>
