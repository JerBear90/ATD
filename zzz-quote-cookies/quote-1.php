	...
	$(document).ready(function() {
	    $("#shippingfromzipentry,#shippingtozipentry").keydown(function (e) {
	        ...
	        if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
            	...
            	<div class="frm-row">
                    <div class="colm colm12" style="color:#666666;text-align: center;padding-top: 15px;">
            		    <strong>Google+ Plus</strong> members give us <strong>5 STARS</strong> 
						(373 Reviews)
                    </div>
            	</div>
            </form>
...
$(document).ready(function() {
	...
	if(getOrderInfo.shippingfromzip!='') {
		$('#shippingfromzipentry').val(getOrderInfo.shippingfromzip + ' (' + decodeParameter(getOrderInfo.shippingfromcity) + ', ' + getOrderInfo.shippingfromstate + ')');
		$('#shippingfromzip').val(getOrderInfo.shippingfromzip);
		$('#shippingfromcity').val(getOrderInfo.shippingfromcity);
		$('#shippingfromstate').val(getOrderInfo.shippingfromstate);
	}

	if(getOrderInfo.shippingtozip!='') {
		$('#shippingtozipentry').val(getOrderInfo.shippingtozip + ' (' + decodeParameter(getOrderInfo.shippingtocity) + ', ' + getOrderInfo.shippingtostate + ')');
		$('#shippingtozip').val(getOrderInfo.shippingtozip);
		$('#shippingtocity').val(getOrderInfo.shippingtocity);
