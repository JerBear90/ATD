	        ...
	        if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
	            e.preventDefault()
	                    ...
	                    <div align="center" class="quote-form-header">
							Get An Instant Quote.<br>No Personal Information<br>Or Payment Required To Book Shipment
		                </div>
                
                <div class="section" style="margin-bottom: 23px;">
                    <div class="frm-row">
                        <div class="colm colm4 centermob">
                            <label for="shippingfromzip" class="field-label"><div class="quoteformlabel">Pick Up Location:</div></label>
                        </div>
                ...
                <div class="section" style="margin-bottom: 23px;">
                    <div class="frm-row">
                        <div class="colm colm4 centermob">
                            <label for="shippingtozip" class="field-label"><div class="quoteformlabel">Delivery Location:</div></label>
                        </div>
