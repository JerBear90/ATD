        ...
        <div class="frm-row">
            ...
            <div class="colm colm6">
	            <div class="quotelistbox1"><br>
		            ...
		            <ul class="quotelist1">
		            	<li>Total Door-to-Door Price: $<?php echo $strTotalPrice ?></li>
			            <li>Payment Only After Your Scheduled Pickup, Credit Card: $<?php echo $strDeposit  ?></li>
			            <li>Balance To Carrier $<?php echo $strBalance  ?> COD/Money Order Upon Delivery</li>
			            <li>There are no taxes or hidden fees</li>
			            <li>Insurance Up To $150,000 Included</li>
		            </ul>
	            </div>
...
-->
				...
				function checkEmail() {
					var currentemail = jQuery('#strCustEmail').val();
					if (currentemail.indexOf("sbcglobal.net") >= 0 || currentemail.indexOf("att.net") >= 0) {
				    	alert('We apologize that your email server for the address ' + currentemail + ' habitually rejects or tosses into spam our emails. We kindly ask that you use an alternate email address.');
				    	jQuery('#strCustEmail').val('');
				    	document.mainform.strCustEmail.focus();
				    }
                ...
                <div class="frm-row">
                    <div class="colm colm12">            
                        E-Mail Address
                        <label class="field append-icon">
                            <input type="text" name="strCustEmail" onblur="checkEmail()" id="strCustEmail" size="30" value="<?php echo $customer_email ?>"  data-idealforms-rules="required email">
                        </label>
                    </div>
                </div>
