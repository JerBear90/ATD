...
if ($cys_success == 1) {
	...
	if ($numofvehicles==1) {
		$paymentdesc = 'Authorized Payment - Credit Card';
		//$sql = "insert into payments (OrderID,Description,Amount,username) values ($strOrderID,'Down Payment - Credit Card','-$strDeposit','$CurrentUsername')";
	} else {
		$paymentdesc = 'Multiple Vehicle Down Payment - Credit Card';
		//$sql = "insert into payments (OrderID,Description,Amount,username) values ($strOrderID,'Multiple Vehicle Down Payment - Credit Card','-$strDeposit','$CurrentUsername')";
	}
	
	$wpdb->insert( 'payments', array(
	    'OrderID' => $strOrderID, 
	...
	if ($wpdb->last_error) {
		...
		atdmail("text","Direct Express Auto Transport Order System", "orders@autotransportdirect.com", "clay@madebysprung.com", "DEAT SQL Error - " . $strOrderID, $currerror);
	}
	...
	$sql = "update orders set status = 'NEW', SalesRep_Complete = '$strSalesRep', order_date = NOW(),Billing_Name = '$strBilling_Name', Billing_Address1 = '$strBilling_Address1', Billing_Address2 = '$strBilling_Address2', Billing_City = '$strBilling_City', Billing_State = '$strBilling_State', Billing_Zip = '$strBilling_Zip', Billing_Phone = '$strBilling_Phone', lp_ApprovalCode = '$Cys_AuthCode', lp_OrderNumber = '$Cys_TransId', cc_lastfour = '$cc_lastfour', cc_capturestatus = 'authorized' where orderid = $strOrderID";
...
//    atdmail("text","Direct Express Auto Transport Order System", "orders@autotransportdirect.com", "clay@madebysprung.com", "New Order - " . $reporteduser . " - " . $strOrderID . " - " . $reporteddate, $body);
    ...
    if ($CarrierTip!='0') {
        ...
        $sql = "insert into payments (OrderID,Description,Amount) values ($strOrderID,'Extra To Move Faster','$CarrierTip')";
    	$wpdb->query($sql);
    }
	...
	$body .= "<td class='bodytext2' nowrap='nowrap'>". $DateAvailable_Initial . " - <strong><a href='https://www.autotransportdirect.com/information-shipping-dates/'>Please see typical shipping time frames</a></strong></td>";
    ...
    $body .= "</font></td></tr></table><img src='https://www.autotransportdirect.com/images/mainbox_bottom.gif' width='700' height='3' alt='' border='0'></td></tr></table><center><br/><font face='Verdana,Geneva,Arial,Helvetica,sans-serif' size='1'>Copyright &copy; " . date('Y') . ", <a href='https://www.autotransportdirect.com/' class='footer'>AutoTransportDirect.com</a><br/>License # MC 479342</p><br><br>All the best!<br><br>Direct Express Auto Transport<br><br><img src='https://www.autotransportdirect.com/images/email-girl.jpg' /><br><br>Direct Express Auto Transport<br>321 San Anselmo Avenue<br>San Anselmo, CA 94960<br>Toll-Free Phone: 800-600-3750<br><br><br>Our Website Domain: <a href='http://www.AutoTransportDirect.com'>http://www.AutoTransportDirect.com</a></center></font></body></html>";
...
if ($cys_success == 1 || $getorder['Status'] == "NEW") {
    ...
    if (!empty($_COOKIE['qid'])) {
    	$sql = "update quote_email set orderid = $strmaxorderid where quoteid = " . $_COOKIE['qid'];
        $wpdb->query($sql);
    }
...
-->
                ...
                Your Order Is Booked!  Upon carrier assignment, $<?php echo $strDeposit ?> will be processed to your credit card. 
...
<!-- 		            <div class="colm colm3"></div> -->
            <div class="colm colm6">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 1 (<?php echo $getorder['Pickup_Phone1Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 2 (<?php echo $getorder['Pickup_Phone2Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 3 (<?php echo $getorder['Pickup_Phone3Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Backup Contact Phone (<?php echo $getorder['Pickup_BackupPhoneType'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 1 (<?php echo $getorder['Deliver_Phone1Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 2 (<?php echo $getorder['Deliver_Phone2Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Phone 3 (<?php echo $getorder['Deliver_Phone3Type'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
                ...
                <div class="frm-row">
                    <div class="colm colm5">
                        <strong>Backup Contact Phone (<?php echo $getorder['Deliver_BackupPhoneType'] ?>):</strong>
                    </div>
                    <div class="colm colm7">
...
-->
			...
			<ol class="orderconf">
				...
				<li><strong>You will hear again from Direct Express Auto Transport via email when we have selected a carrier to transport your vehicle(s).</strong> The subject title of that email will read, "Your Vehicle Has Been Assigned A Carrier". We have it programmed to alert you via email the very second we assign your order. So that's how you'll know we have a driver arranged. In the body of that email, we will reconfirm the amount due the carrier in money order or cash, the name of the carrier, their phone number, the date the carrier told us they expected to pick up your vehicle and the estimated delivery date. All good information to know. </li>
				
				<li><strong>At the same time your vehicle is assigned a carrier, your credit card deposit will be processed.</strong> We wait until we are successful to charge your card. In the assignment email, we remind you once again the deposit charged to your card, and the balance due the carrier upon delivery in Cash or Money Order. </li>
				
				<li><strong>The carrier should call you in advance of your pick up date and time.</strong> They should not just show up unannounced. It's also in their best interest to call ahead of time, usually the day before, and as well the day of pick up. Just so you know, the carriers sometimes miss the appointed hour to meet. It's so hard to schedule exactly because yours is probably one of several appointments that day. If even one person causes a delay, then everybody else gets backed up. In advance we apologize for that and ask for your patience and understanding. If you haven't heard from the carrier in advance of your pick up, we at Direct Express want to know about it. We don't like dropped balls ... at all.</li>
				
				<li><strong>From the road, the carrier should call you in advance of your deliver date and time.</strong> Here again they should not just show up unannounced. It's also in their best interest to call ahead of time from the road, usually the day before, and as well the day of delivery. Once again, the carriers may miss the appointed hour to meet for the same reasons as stated above. They want to be punctual, but circumstances beyond their control often derail them. They would like nothing better than to deliver your vehicle, get paid ... and do it all again with that space. It's hard work, folks, and we appreciate their effort. Any tip you may give your driver is very cool.</li>
				
				<li><strong>Don't forget to inspect your vehicle upon pickup and especially upon delivery.</strong> Note any damages while in the presence of the carrier. That's your opportunity to raise any issue. Complaints are very rare. It's why you see new cars being delivered to dealerships this way. There is a complaint in only 1 out of every 200 shipments. And that's usually innocuous or minor. Rarely is there anything significant. Your vehicle is insured up to $150,000 by the way.</li>
