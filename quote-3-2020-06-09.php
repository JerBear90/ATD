    ...
    <div class="smart-forms">
	    ...
	    <div class="frm-row" style="margin: 20px 0 10px;">
            <div class="colm colm7">
	            ...
	            <div style="font-size: 22px; line-height: 28px; font-weight: 600 !important;">Direct Express Auto Transport is the highest rated and most reliable car shipper! Going strong since 2004.<div style="margin-top:10px;"></div>
		            ...
		            jQuery(document).ready(function() {
		                ...
		                <div class="section fieldentry">
		                        ...
		                        <div class="colm colm4 levelofservice" >
		                            <div class="pricerow">Standard Price<br><span style="color: red;font-size: 15px; margin-top:-6px;">&nbsp;</span><br><span id="displaybalancestandard" style="color: #1a73e8;font-weight: bold;">$<?php echo $totalprice ?></span></div>
		                             <p style="margin-top: 10px;">Assigned 1-7 days from first date available usually 85% of the time.</p>
		                            <div align="center"><button id="confirmLink1" class="submitbutton3" style="width:90%;">Set&#8209;up<br/>Standard<br/>Shipment</button></div>
		                            <p style="margin-top: 10px;">
										...
										$<?php echo $balancestandard ?> balance to Carrier in<br/>Cash or Money Order Upon Delivery.
		                            </p>
		                        </div>
		                        ...
		                        <div class="colm colm4 levelofservice" style="background: #FFFCD8;">
		                            <div class="pricerow">Expedited Price<br><span style="color: red;font-size: 15px; margin-top:-6px;">(recommended)</span><br><span id="displayexpeditedprice" style="color: #1a73e8;font-weight: bold;">$<?php echo $expeditedprice ?></span></div>
		                             <p style="margin-top: 10px;">Assigned 1-4 days from first date available usually 90% of the time.</p> 
		                            <div align="center"><button  id="confirmLink2" class="submitbutton3" style="width:90%;">Set&#8209;up<br/>Expedited<br/>Shipment</button></div>
		                            <p style="margin-top: 10px;">
										<div style="margin-bottom: 14px;">$0 Due Now</div>
										<div style="margin-bottom: 14px;">$<?php echo $strDepositSHOW ?> payment processed upon Carrier Assignment.</div>
										$<?php echo $balanceexpedited ?> balance to Carrier in<br/>Cash or Money Order Upon Delivery.
		                            </p>
		                        </div>
                   
		                        <div class="colm colm4 levelofservice" >
		                            <div class="pricerow">Rush Price<br><span style="color: red;font-size: 15px; margin-top:-6px;">(fastest)</span><br><span id="displayrushprice" style="color: #1a73e8;font-weight: bold;">$<?php echo $rushprice ?></span></div>
		                             <p style="margin-top: 10px;">Assigned 1-2 days from first date available usually 95% of the time.</p>
		                            <div align="center"><button id="confirmLink3" class="submitbutton3" style="width:90%;">Set&#8209;up<br/>Rush<br/>Shipment</button></div>
		                            <p style="margin-top: 10px;">
										<div style="margin-bottom: 14px;">$0 Due Now</div>
										<div style="margin-bottom: 14px;">$<?php echo $strDepositSHOW ?> payment processed upon Carrier Assignment.</div>
										$<?php echo $balancerush ?> balance to Carrier in<br/>Cash or Money Order Upon Delivery.
		                            </p>
		                        </div>
