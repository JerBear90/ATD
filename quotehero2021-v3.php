	    ...
	    $("#shippingfromzipentry,#shippingtozipentry").keydown(function (e) {
	        ...
	        if ((e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) && (e.keyCode < 96 || e.keyCode > 105)) {
                ...
                <div class="section" style="margin-bottom: 23px;">
                	<div class="frm-row">
						<div class="colm colm12">
		                    <div align="center" class="quotetop">Get your instant car shipping quote<br>now or call 800-600-3750</div>
	                    </div>
	            	</div>
                </div>
				...
				<div class="section" style="margin-bottom: 23px;">
                    <div class="frm-row">
                        <div class="colm colm12">
                            <div class="option-group field" style="text-align: center;">
            	...
            	<div class="frm-row">
                    <div class="colm colm12">
            		    ...
            		    <input type="button" onclick="submitquote();" value="Continue to Year, Make & Model" class="submitquotev2" style="cursor: pointer;"/>
