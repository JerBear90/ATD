            ...
            <div class="colm colm5">
                ...
                <div class="frm-row">
                    <div class="colm colm12">
                        City:
                        <label class="field append-icon">
                            <input type="text" name="strPickup_City" id="strPickup_City" size="30" value="<?php echo $strQuote_shippingfromcity  ?>">
                ...
                <div class="frm-row">
                    <div class="colm colm12">
                        ...
                        <br>
                        <input type="checkbox" name="strPickup_ExtraInst_Send" id="strPickup_ExtraInst_Send" value="yes" /> Put Extra Instructions on B.O.L.
                        <?php
            ...
            <div class="colm colm5">
                ...
                <div class="frm-row">
                    <div class="colm colm12">     
                        City:<br>
                        <label class="field append-icon">
                            <input type="text" name="strDeliver_City" id="strDeliver_City" size="30" value="<?php echo $strQuote_shippingtocity  ?>">
                ...
                <?php if(session('admin')!="") { ?>
                    <div class="frm-row">
                        <div class="colm colm12">
                            Extra Instructions:<br>
                            <input type="text" name="strDeliver_ExtraInst" id="strDeliver_ExtraInst" size="40" maxlength="200"><br>
                            <input type="checkbox" name="strDeliver_ExtraInst_Send" id="strDeliver_ExtraInst_Send" value="yes" /> Put Extra Instructions on B.O.L.<br>
