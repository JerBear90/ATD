    ...
    <div class="section">
        <div class="frm-row">
            ...
            <div class="colm colm10" style="text-align: center;">
                ...
                Your transaction is successful.  $<?php echo $strDeposit ?> has been charged to your credit card as a deposit.<br/>
                Please print out this page as your order receipt.  Call 1-800-600-3750 with any questions.<br/>
            ...
            <div class="colm colm6">
                ...
                <div class="frm-row">
                    <div class="colm colm12">
                        ...
                        <div class="smalltext">A deposit of $<?php echo $getorder['Deposit'] ?> to be billed to your credit card.</div>
                        <div style="margin:5px 0 5px 0;width:100%;border-top:#999999 solid thin;"></div>
                    </div>
                </div>
                <div class="frm-row">
