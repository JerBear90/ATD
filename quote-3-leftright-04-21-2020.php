			...
			<div class="section fieldentry" >
		        <div class="frm-row">
		            <div class="colm colm12" style="text-align: center;">
		                ...
		                <div style="font-size:20px;font-weight: bold;">Book Online or Call</div>
		                <div style="font-size:40px;color:#308dff;position:relative;font-weight:bold;">800-600-3750</div>
		                
		            </div>
		            <div class="colm colm12 ">
                        <div style="height: 1px; border-top:6px solid #868686; margin: 20px 0 0;"></div>
                    </div>
		        </div>
		    </div>
-->
		    ...
		    <div class="section fieldentry" >
		        <div class="frm-row">
		            <div class="colm colm5 quoteinfocol">
		            ...
		            jQuery(document).ready(function() {
		                ...
		                <div class="section fieldentry">
		                    ...
		                    <div class="frm-row setupship levelofservice" style="padding-bottom:20px;margin-top: 8px !important;">
		                        <?php
								...
								<div class="colm colm12">
		                            <div style="font-weight:bold; text-align: left; font-size: 20px;">
		                                Choose My Level of Service
		                            </div>
		                        </div>
		                        
		                        <div class="colm colm12">
			                        <div style="height: 1px; border-top:6px solid #868686; margin: 20px 0;"></div>
		                        </div>
		                        
		                        <div class="colm colm12 " style="text-align: left;">
		                            <div class="pricerow">Standard Price &nbsp; <span style="color: red;font-size: 15px; margin-top:-6px;">(most popular)</span> &nbsp; <span id="displaybalancestandard" style="color: #000;font-weight: bold;">$<?php echo $totalprice ?></span></div>
		                             <p style="margin-top: 10px;">Usually assigned 1-7 days from first date available.<br>Probability: 85%</p>
		                            <div align="center"><button id="confirmLink1" class="submitbutton3" style="width:90%;">Select Standard set&#8209;up shipment</button></div>
		                            <p style="margin-top: 10px;">
			                            Credit Card Deposit: $<?php echo $strDepositSHOW ?><br/>
										Balance: $<?php echo $balancestandard ?>  in Cash/Money Order Upon Delivery.<br/>
		                            </p>
		                        </div>
		                        
		                        <div class="colm colm12 ">
			                        <div style="height: 1px; border-top:6px solid #868686; margin: 10px 0 20px 0;"></div>
		                        </div>
		                        
		                        <div class="colm colm12 " style="text-align: left;">
		                            <div class="pricerow">Expedited Price &nbsp; <span style="color: red;font-size: 15px; margin-top:-6px;">(recommended)</span> &nbsp; <span id="displayexpeditedprice" style="color: #000;font-weight: bold;">$<?php echo $expeditedprice ?></span></div>
		                             <p style="margin-top: 10px;">Usually assigned 1-4 days from first date available.<br>Probability: 90%</p> 
		                            <div align="center"><button  id="confirmLink2" class="submitbutton3" style="width:90%;">Select Expedited set&#8209;up shipment</button></div>
		                            <p style="margin-top: 10px;">
			                            Credit Card Deposit: $<?php echo $strDepositSHOW ?><br/>
										Balance: $<?php echo $balanceexpedited ?>  in Cash/Money Order Upon Delivery.<br/>
		                            </p>
		                        </div>
		                        ...
		                        <div class="colm colm12" style="text-align: left;">
		                            <div class="pricerow">Rush Price &nbsp; <span style="color: red;font-size: 15px; margin-top:-6px;">(fastest)</span> &nbsp; <span id="displayrushprice" style="color: #000;font-weight: bold;">$<?php echo $rushprice ?></span></div>
		                             <p style="margin-top: 10px;">Usually assigned 1-2 days from first date available.<br>Probability: 95%</p>
		                            <div align="center"><button id="confirmLink3" class="submitbutton3" style="width:90%;">Select Rush set&#8209;up shipment</button></div>
		                            <p style="margin-top: 10px;">
			                            Credit Card Deposit: $<?php echo $strDepositSHOW ?><br/>
										Balance: $<?php echo $balancerush ?> in Cash/Money Order Upon Delivery.<br/>
		                            </p>
		                        </div>
			            ...
			            <div class="colm colm12 shippinginfo">
					        ...
					        <div class="frm-row">
					            <div class="colm colm12">
						            ...
						            <strong>Direct Express Auto Transport is the highest rated and most reliable car shipper! Going strong since 2004.</strong><BR><BR>
					            </div>
					        </div>
	                        ...
	                        <div class="frm-row carinfo" style="width: 100%">
		                        <div class="colm colm12">
			                        <div class="frm-row">
		            ...
		            <div class="colm colm12 endscroll">
                        <div style="height: 1px; border-top:6px solid #868686; margin: 20px 0;"></div>
                    </div>
		        </div>
		    </div>
                ...
                <div class="section fieldentry">
                    <div class="frm-row">
                        <div class="colm colm12" style="text-align: center;  font-size: 1.1em;margin-bottom: 20px;">
							...
							<p>Credit or Debit Card Deposit $<?php echo $strDeposit ?> (included in price).</p>
                        </div>
                    </div>
